...
var is_open := false
var includes_delay_for_starting_new_level := false
var has_delay_elapsed := false
...
func _input(event):
    if is_open and \
            ...
            (!includes_delay_for_starting_new_level or has_delay_elapsed):
        _start_new_level()
